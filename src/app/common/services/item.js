angular.module('ieecloud-fm').factory('Item', ['$http', '$q', '$translate', 'fileManagerConfig', 'chmod', function ($http, $q, $translate, fileManagerConfig, Chmod) {
    ...
    var Item = function (model, path) {
        var rawModel = {
            ...
            size: model && parseInt((model.size || 0),10),
